  ...
  return (
    <div className="skill">
      ...
      <p className="pList-desc w-75 mx-auto my-5">
        ...
        full-stack solutions. My frontend expertise includes React.js, Next.js,
        and Typescript. On the backend, I am proficient with Node.js,
        ...
        technology stack, ensuring efficient development and optimal performance
        for your projects..
      </p>
